...
- [x] 14-R04-PLAN.md — Render home + quienes-somos + testimonios + taller + genéricos Hero/FeatureGrid/Pricing (SCH-01)
- [x] 14-R05-PLAN.md — Render diplomado (audience, curriculum 16 semanas, howItWorks, team, benefits, pricing) (SCH-01)
- [x] 14-R06-PLAN.md — Render reto (barra urgencia, hero, mentora, agenda, premios, ganadores, etc.) (SCH-01)
...
| 14. Modelo de contenido — Globals, colecciones, blocks y seed | 14/15 | In Progress|  |
