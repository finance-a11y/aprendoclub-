...
- [ ] 14-R01-PLAN.md — 29 bloques bespoke (un tipo por sección única) + barrel allBlocks[] (SCH-01)
- [ ] 14-R02-PLAN.md — Colección Pages (slug+layout+SEO) + eliminar 7 page-globals + migración + seoPlugin→pages (SCH-01)
...
| 14. Modelo de contenido — Globals, colecciones, blocks y seed | 8/8 | Complete   | 2026-07-05 |
