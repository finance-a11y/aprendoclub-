...
import { Check, Trophy, MessageCircle, ArrowRight } from "lucide-react";
...
export function PricingSection() {
  return (
    <section id="precios" className="bg-[var(--bg-primary)] py-16 px-5 font-['Montserrat']">
      <Eyebrow as="p" className="text-center tracking-[3px] mb-3">
        PRECIOS
      </Eyebrow>
      <h2 className="text-white text-4xl font-semibold text-center mb-3 leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-3xl mx-auto mb-5">
        ...
        {/* Card 1: Cuotas */}
        <div className="bg-[var(--bg-primary)] border border-[var(--bg-tertiary)] rounded-2xl p-9 flex flex-col">
          ...
          <a
            ...
            className="block w-full text-center py-4 rounded-xl border border-[var(--bg-tertiary)] text-gray-300 font-semibold text-[15px] hover:border-white hover:text-white transition"
          >
            Comenzar en cuotas
          </a>
        </div>
        ...
        <div className="relative bg-[var(--bg-primary)] border-2 border-[var(--primary-light)] rounded-2xl p-9 flex flex-col shadow-[0_0_40px_rgba(61,92,245,0.12)]">
          ...
          <a
            ...
            className="flex w-full items-center justify-center gap-2 py-4 rounded-xl bg-[var(--primary-light)] text-white font-semibold text-[15px] hover:bg-[var(--primary)] transition"
          >
      ...
      {/* Card 3: CTA WhatsApp */}
      <div className="max-w-3xl mx-auto bg-[var(--bg-primary)] border-2 border-[var(--accent)] rounded-2xl p-10 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-2 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2.5 bg-[var(--accent)] text-[var(--bg-primary)] font-semibold text-[15px] px-7 py-5 rounded-2xl hover:brightness-110 transition whitespace-nowrap"
          >
