...
import type { DiplomadoGaleriaBlock as DiplomadoGaleriaBlockType } from '@/payload-types'

/**
 * Render de 'diplomadoGaleria': eyebrow/titulo/texto + galería masonry de
 * `imagenes` con lightbox. Espeja components/blocks/render/RetoGaleria.tsx
 * (cierre con Escape + bloqueo de scroll cuando el lightbox está abierto).
 */
export function DiplomadoGaleria({ block }: { block: DiplomadoGaleriaBlockType }) {
      ...
      <AnimatePresence>
        {imagenActiva && (
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Foto del Diplomado ampliada"
...
export default DiplomadoGaleria
